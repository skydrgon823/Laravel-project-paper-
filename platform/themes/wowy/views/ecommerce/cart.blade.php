            ...
            <div class="col-12 section--shopping-cart">
                <form class="form--shopping-cart" method="post" action="{{ route('public.cart.update') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-des product-name">
                                                ...
                                                @if (!empty($cartItem->options['extras']) && is_array($cartItem->options['extras']))
                                                    @foreach($cartItem->options['extras'] as $key=>$option)
                    ...
                    <div class="cart-action text-end">
                        <a class="btn btn-rounded" style="border:none; background-color:#12a05c; font-size:20px"href="{{ route('public.products') }}"><i class="far fa-cart-plus mr-5"></i>{{ __('Produkte entdecken') }}</a>
                    </div>
                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius-10 cart-totals">
                                    ...
                                    <button type="submit" name="checkout" class="btn btn-rounded"style="border:none; background-color:#12a05c; font-size:20px"> <i class="fa fa-share-square mr-10"></i> {{ __('Angebot erhalten') }}</button>
                                </div>
                            </div>
                        </div>
                    @endif
                @else
                    <p class="text-center">{{ __('Ihre Wunschliste ist leer!') }}</p>
                @endif
            </div>
        </div>
    </div>
