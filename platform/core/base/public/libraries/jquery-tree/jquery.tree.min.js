    ...
    a.widget("daredevel.tree", {
        ...
        _initializeComponents: function () {
            for (var d in this.options.components) {
                var c =
                    "element.tree" + this.options.components[d] + "(options);";
        ...
        _checkAncestors: function (c) {
            c.parentsUntil("daredevel-tree")
                .filter("li")
                .find("input:checkbox:first:not(:checked)")
                .prop("checked", true)
                .change();
        },
        _checkDescendants: function (c) {
            c.find("li input:checkbox:not(:checked)")
                .prop("checked", true)
                .change();
        },
        ...
        _createCheckbox: function () {
            ...
            if (this.options.onUncheck.node == "collapse") {
                this.element.on(
                    ...
                    "input:checkbox:not(:checked)",
                    function () {
                        c.options.core.collapse(
                            c.options.core.parentNode(a(this))
                        );
                    }
                );
            } else {
        ...
        _uncheckAncestors: function (c) {
            c.parentsUntil("daredevel-tree")
                .filter("li")
                .find("input:checkbox:first:checked")
                .prop("checked", false)
                .change();
        },
        ...
        check: function (c) {
            c = a(c);
            c.find("input:checkbox:first:not(:checked)")
                .prop("checked", true)
                .change();
            ...
            if (this.options.onCheck.ancestors == "check") {
                ...
                if (this.options.onCheck.ancestors == "uncheck") {
                    ...
                    if (this.options.onCheck.ancestors == "checkIfFull") {
                        ...
                        var e = this._allDescendantChecked(
                            this.options.core.parentNode(c)
                        );
                        if (!d && e) {
        ...
        uncheck: function (c) {
            c = a(c);
            c.find("input:checkbox:first:checked")
                .prop("checked", false)
                .change();
        ...
        _initializeCollapsibleNode: function (c) {
            ...
            if (d.length < 1) {
                c.prepend(a("<span />", { class: "daredevel-tree-anchor" }));
            }
            if (c.hasClass("leaf")) {
                e._markAsLeaf(c);
            } else {
        ...
        _markAsCollapsed: function (c) {
            ...
            d.removeClass(
                "ui-icon " +
                    this.options.expandUiIcon +
                    " " +
                    this.options.leafUiIcon
            );
        ...
        _initializeDndNode: function (c) {
            ...
            a(c)
                .find(".daredevel-tree-label:first")
                .draggable({
                    start: function (f, g) {
                        a(this)
                            .parent("li")
        ...
        _createSelectable: function () {
            var d = this;
            var c =
                ".daredevel-tree-label:not(." +
                this.options.selectUiClass +
                ")";
        ...
        _deselect: function (c) {
            c.find("span.daredevel-tree-label:first").removeClass(
                this.options.selectUiClass
            );
        ...
        _select: function (c) {
            c.find("span.daredevel-tree-label:first").addClass(
                this.options.selectUiClass
            );
        ...
        deselect: function () {
            var c = this;
            this.element
                .find(".daredevel-tree-label." + this.options.selectUiClass)
                .each(function () {
        ...
        selected: function () {
            var c = this.element.find(
                ".daredevel-tree-label." + this.options.selectUiClass
            );
            return a(c).parent();
        },
        options: {
